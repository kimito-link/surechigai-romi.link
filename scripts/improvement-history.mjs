...
export const IMPROVEMENT_HISTORY = Object.freeze([
  Object.freeze({
    version: '1.0.0', metric: 'tests-passed', value: 851,
    source: '[auto] node scripts/qa/count-metric.mjs tests-passed'
  }),
  Object.freeze({
    version: '1.0.0', metric: 'gates', value: 5,
    source: '[auto] node scripts/qa/count-metric.mjs gates'
  }),
  Object.freeze({
    version: '1.0.0', metric: 'selftest-missing', value: 7,
    source: '[auto] node scripts/qa/count-metric.mjs selftest-missing'
  })
]);
