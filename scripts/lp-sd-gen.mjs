...
const JOBS = [
  ...
  { id:'yukinohara', w:768, h:432, prompt:'view from inside a dark train tunnel looking out through the round tunnel exit, beyond the opening a vast snow country landscape revealed, snow-covered mountains and snowy forest bathed in pale white light, heavy snow falling outside, railway tracks leading out of the tunnel into the white world, the dark round tunnel frame around the bright snowy view, kawabata yukiguni atmosphere, the moment of emerging from the tunnel into snow country, photorealistic, cinematic, serene, film grain', neg_extra:'sunny blue sky, bright sunlight' },
  ...
  // 縦長(576x896)。cover でスマホ縦画面でも器ごとかき氷が収まる構図（横長だと中央拡大で見切れ＋マスクで二重像になる）
  { id:'kakigori', w:576, h:896, prompt:'a tall vertical photo of a single glass bowl of japanese shaved ice kakigori with bright red strawberry syrup, melting ice mountain, a red droplet of syrup running down the glass, condensation, the bowl sits on a wooden table in the lower-center of a vertical frame, behind it the warm blurry bokeh of a japanese summer festival night with red paper lanterns and food stalls, deep blue night, vivid red ice as the main subject, photorealistic, refreshing yet bittersweet, shallow depth of field, film grain, vertical composition', neg_extra:'second bowl, two bowls, duplicate, reflection, mirror image, split frame' },
  ...
  { id:'mugiwara', w:768, h:432, prompt:'an empty straw hat with a red ribbon floating in the air against a bright blue summer sky with white clouds, the hat is medium sized in the upper half of the frame, a green field at the bottom, blown by a gentle breeze, plenty of sky around the hat, no people, nostalgic japanese summer, photorealistic, airy, sense of wind, film grain', neg_extra:'person, people, human, face, woman, man, child, girl, boy, body, hand, head, extreme close-up' },
  // 麦わら帽子シーンの背景（あだち充風の構図・人物なし）。手前にリンクちゃんを重ねる前提で右上に帽子・左に余白
  { id:'mugiwara-bg', w:512, h:768, prompt:'a serene stone staircase going up beside lush green summer trees, bright blue sky with soft clouds in the upper right, a red-ribboned straw hat tumbling through the air in the upper right sky blown by the wind, dappled sunlight, nostalgic shonen manga summer atmosphere, watercolor-like soft light, no people, empty staircase, photorealistic background with anime nostalgia, film grain, gentle and emotional', neg_extra:'person, people, human, face, woman, man, child, girl, boy, body, hand, characters, figure' },
