...
最重要メッセージは **「現在地でつながる、すれ違ひ通信」** です。このコピーは単なる見出しではなく、プロダクトの情緒と機能の中心です。
...
`現在地でつながる、すれ違ひ通信` は、最初に目に入る感情の核として扱います。  
...
感情の入口です。`現在地でつながる、すれ違ひ通信` を強く扱い、レーダー、電波、信号、現在地の存在感を出します。  
...
- `現在地でつながる、すれ違ひ通信` または同等の核が弱くなっていない
