...
import { type SponsorCardData } from "@/components/molecules/sponsor-card";
import { CheckinScreenView } from "@/components/checkin/checkin-screen-view";
import {
...
export default function CheckinAuthenticatedScreen() {
  ...
  return (
    <CheckinScreenView
      ...
      locatingBannerText={locatingBannerText}
      mapHeroHeight={mapHeroHeight}
      tabInset={tabInset}
      ...
      adjustAccuracyHint={adjustAccuracyHint}
      ...
      handleMapPinAdjust={handleMapPinAdjust}
