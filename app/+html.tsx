  ...
  return (
    <html lang="ja">
      <head>
        ...
        {/* SPLASH-LINKS:BEGIN — 自動生成。手で編集しない（pnpm splash:sync で再生成） */}
        {/* iPhone SE 4-inch */}
        <link
